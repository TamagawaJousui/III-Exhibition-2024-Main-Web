export const conceptData = {
    ja: [
        ...
        `私たちが自己や世界との・距離を測るとき、・それらと付かず離れず、・曖昧で消極的な間に・漂泊していてよいのだろうか。・`,
        `本展覧会を通して、・付いて離れて、・行き交いながら、・自発的で新しい関係構築を・志向してゆく。`,
    ],
    en: `Technology and art, humans and machines, works and viewers...
