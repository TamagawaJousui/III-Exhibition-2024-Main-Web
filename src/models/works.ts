...
export const workList = [
    ...
    },
    {
        ...
        member: ["友利未夢", "ルイヴィル・デリーアン", "常盤優菜", "増澤茉利子", "谷凪彩", "あん"],
        place: "情報学環オープンスタジオ",
        description: {
    ...
    },
    {
        ...
        imagePath: "/works/Teidai Gesui.png",
    },
    {
        ...
        imagePath: "/works/Whole Teidai Gesui Catalog.png",
    },
    {
        title: "umoru",
    ...
    },
    {
        ...
        imagePath: "/works/The Scent of Waterfall.png",
    },
    {
        title: "メンヘラ・リフレクション",
        member: ["西岡春菜"],
        ...
        imagePath: "/works/Mental Health Reflection.png",
    },
    {
        title: "Another Path",
        ...
        imagePath: "/works/Another Path.png",
    },
    {
        title: "鏡",
        member: ["王文鶴", "中野博貴", "Xu Jinyi"],
        ...
        imagePath: "/works/The Mirror.png",
    },
    {
        title: "書動",
        member: ["小西優多郎", "田中祐玖", "都築あい", "Xi Jingfan"],
        place: "情報学環オープンスタジオ",
        description: {
            ja: `文章を生み出していく執筆のリズムや、一文字一文字の筆運びに宿るリズム。書かれたものではなく、書いている最中に奏でられるリズムから何を読み取り、何を感じるのか。`,
            en: "",
        },
        imagePath: "/works/SHODO: trajectory of handwriting.png",
    },
    {
        title: "存える",
    ...
    },
    {
        ...
        imagePath: "/works/The Flavor of Hearts.png",
    },
    {
        ...
        imagePath: "/works/CottonSketchPen.png",
    },
    {
        title: "Geocussion",
        member: ["岡空来"],
        ...
        imagePath: "/works/Geocussion.png",
    },
    {
        title: "Protophysica",
        member: ["南田桂吾"],
        ...
        imagePath: "/works/Protophysica.png",
    },
    {
        title: "覗香",
        member: ["岡空来"],
    ...
    },
    {
        ...
        imagePath: "/works/Exquisite Corpse with Generative AI.png",
    },
    {
        title: "バードっち",
        member: [
    ...
    },
    {
        ...
        imagePath: "/works/Fragments of the City.png",
    },
    {
        title: "Droplens",
        member: ["大平麻以"],
    ...
    },
    {
        ...
        imagePath: "/works/VoiceStorming.png",
    },
    {
        title: "本郷キャンパス謎巡り　ーAさんの消失ー",
        member: ["李嘉懿", "莫子敏", "Xi Jingfan", "胡欣雨"],
        place: "工学部2号館フォーラム",
        description: {
        ...
        imagePath: "/works/Hongo Campus Treasure Hunting Tour - The Missing of A -.png",
    },
    {
        title: "至揺",
        member: ["仲村友杜"],
    ...
    },
    {
        ...
        imagePath: "/works/Topology optimization of T-shirts.png",
    },
    {
        title: "サンゴポリプのシノブトウ",
        member: ["カ モクセイ"],
        ...
        imagePath: "/works/The Dance of Death of Coral Polyps.png",
    },
    {
        title: "触れる不可能立体",
        member: ["横井総太朗"],
        ...
        imagePath: "/works/Tangible Impossible Object.png",
    },
    {
        title: "寝床",
        member: ["井上国太郎", "中村雅人"],
        ...
        imagePath: "/works/A Space to Sleep.png",
    },
    {
        title: "Hand",
        member: ["中根葵"],
    ...
    },
    {
        ...
        place: "工学部2号館展示室",
        description: {
            ja: `"この作品は、歯車の運動と占星術のシンボルを融合させた占い装置である。特に月の位置とその相位の変化に注目し、これが人間の感情や潜在意識、内面的世界に与える影響を探求する。装置の動きは、偏光板が重なるたびに新たなパターンが現れる体験を提供する。
            意味の解釈と生成は、装置とのインタラクションを通じて初めて生まれる。装置との対話においては、自身との内面的な対話の痕跡を残しながら、自らの感情や潜在意識を理解する手助けを得ることが期待されている。
            「あなたの一日が幸せでありますように。」"`,
            en: "",
        },
        imagePath: "/works/WHEEL of MOON PHASE.png",
    },
    {
        title: "Metransfer",
        member: ["南田桂吾"],
        ...
        imagePath: "/works/Metransfer.png",
    },
    {
        title: "Puflica",
        member: ["中田裕紀"],
