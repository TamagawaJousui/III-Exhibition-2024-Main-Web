...
export const PrevButton: React.FC<PropType> = (props) => {
    ...
    return (
        <button className={clsx(styles.button, "embla__button--prev")} type="button" {...restProps}>
...
export const NextButton: React.FC<PropType> = (props) => {
    ...
    return (
        <button className={clsx(styles.button, "embla__button--next")} type="button" {...restProps}>
            <svg className={styles.buttonSvg} viewBox="0 0 532 532">
                <path
                    fill="currentColor"
