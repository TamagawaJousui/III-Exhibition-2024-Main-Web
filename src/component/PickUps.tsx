...
export default function PickUps() {
    ...
    return (
        <div className="max-w-[min(calc(50svh),768px)]">
            <div className="second-title">ピックアップ</div>
            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex">
                    {slides.map((slide) => (
                        ...
                        >
                            <div className="max-w-[min(calc(50svh),768px)] rounded-3xl bg-pickup-background">
